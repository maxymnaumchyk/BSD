    ...
    class AI
    {
        ...
        public Image ToImg(Maze maze, Robot robot, Robot robot2, Robot robot3, int cellSize = 25)
        {
            ...
            using (var g = Graphics.FromImage(img))
            {
                ...
                var myBruh1 = new SolidBrush(Color.Green);
                g.FillRectangle(myBruh1, new Rectangle(cellSize * robot.Location.X + cellSize / 2, cellSize * robot.Location.Y + cellSize / 2, 6, 6));
                var myBruh2 = new SolidBrush(Color.Red);
                g.FillRectangle(myBruh2, new Rectangle(cellSize * robot2.Location.X + cellSize / 2, cellSize * robot2.Location.Y + cellSize / 2, 6, 6));
                var myBruh3 = new SolidBrush(Color.Blue);
                g.FillRectangle(myBruh3, new Rectangle(cellSize * robot3.Location.X + cellSize / 2, cellSize * robot3.Location.Y + cellSize / 2, 6, 6));
            }
            return img;
        }
